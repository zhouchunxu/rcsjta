 ...
 */
public class VemoticonInfoParser extends DefaultHandler {
    ...
    private static Logger sLogger = Logger.getLogger(VemoticonInfoParser.class.getName());
     ...
     */
    public VemoticonInfoParser(InputSource inputSource) {
     ...
     */
    public VemoticonInfoParser parse() throws ParserConfigurationException, SAXException,
