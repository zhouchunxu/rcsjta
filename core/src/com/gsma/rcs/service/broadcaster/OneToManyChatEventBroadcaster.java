...
/**
 * OneToManyChatEventBroadcaster maintains the registering and unregistering of
 * IOneToManyChatEventListeners and also performs broadcast events on these listeners upon the
 * trigger of corresponding callbacks.
 */
public class OneToManyChatEventBroadcaster implements IOneToManyChatEventBroadcaster {

    private final RemoteCallbackList<IOneToManyChatListener> mListeners = new RemoteCallbackList<>();

    private final Logger logger = Logger.getLogger(getClass().getName());

    public OneToManyChatEventBroadcaster() {
    }

    public void addOneToManyChatEventListener(IOneToManyChatListener listener) {
        mListeners.register(listener);
    }

    public void removeOneToManyChatEventListener(IOneToManyChatListener listener) {
