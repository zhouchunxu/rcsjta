...
/**
 * Interface to perform broadcast events on OneToManyStandaloneMessagingListeners
 */
public interface IOneToManyStandaloneMessagingEventBroadcaster {

    void broadcastMessageStatusChanged(String chatId, String mimeType, String msgId, Status status,
            ReasonCode reasonCode);

    void broadcastMessageDeliveryInfoChanged(String chatId, ContactId contact, String mimeType,
