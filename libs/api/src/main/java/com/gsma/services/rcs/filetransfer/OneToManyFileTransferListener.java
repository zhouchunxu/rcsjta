...
/**
 * One-to-many file transfer event listener
 */
public abstract class OneToManyFileTransferListener {

    /**
     * Callback called when the one-to-many file transfer status/reasonCode is changed.
     *
    ...
    /**
     * Callback called when a one-to-many file transfer state/reasonCode is changed for a single recipient
     * only.
     *
     * @param chatId Id of chat
    ...
    /**
     * Callback called during the transfer progress of one-to-many file transfer
     *
     * @param chatId Id of chat
     * @param transferId Id of file transfer
    ...
    /**
     * Callback called when a delete operation completed that resulted in that one or several one-to-many
