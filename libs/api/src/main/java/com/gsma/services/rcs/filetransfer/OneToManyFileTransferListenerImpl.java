...
/**
 * One-to-many file transfer event listener implementation
 *
 * @hide
 */
public class OneToManyFileTransferListenerImpl extends IOneToManyFileTransferListener.Stub {

    private final OneToManyFileTransferListener mListener;

    private final static String LOG_TAG = OneToManyFileTransferListenerImpl.class.getName();

    OneToManyFileTransferListenerImpl(OneToManyFileTransferListener listener) {
        mListener = listener;
    }
